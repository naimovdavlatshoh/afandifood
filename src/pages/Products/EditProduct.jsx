...
export function EditProduct({ changeStatus, item }) {
    const [open, setOpen] = useState(false);
    const [productNameUz, setProductNameUz] = useState(item.product_name_uz);
    const [productNameRu, setProductNameRu] = useState(item.product_name_ru);
    const [productWeight, setProductWeight] = useState(item.product_weight);
    ...
    const handleSubmit = () => {
        ...
        PostDataTokenJson(`api/product/update/${item.product_id}`, data)
            .then((res) => {
                changeStatus();
                setOpen(false);
                setProductNameUz("");
